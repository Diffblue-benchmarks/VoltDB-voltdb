...
public class Site implements Runnable, SiteProcedureConnection, SiteSnapshotConnection
{
    ...
    private long callApplyBinaryLogEE(ByteBuffer paramBuffer, long txnId, long spHandle, long uniqueId, int remoteClusterId, long remoteUniqueId)
        ...
        try {
            ...
            DRTableNotFoundException tableNotFound = (DRTableNotFoundException) e;
            tableNotFound.setRemoteTxnUniqueId(remoteUniqueId);
            tableNotFound.setCatalogVersion(getSystemProcedureExecutionContext().getCatalogVersion());
            throw e;
        }
    }
